...
export const startAddingUserEvent = event => ({
    type: types.EVENT_PERSON_ADDED_STARTED,
    payload: {
        userid
    },
})
...
//FETCHING PERSONS
export const startFetchingPersonEvents = () => ({
    type: types.EVENTS_FETCH_STARTED,
  });
export const completeFetchingPersonEvents = (entities, order) => ({
    type: types.EVENTS_FETCH_COMPLETED,
    payload: {
        entities,
        order,
...
export const failFetchingPersonEvent = error => ({
    type: types.EVENTS_FETCH_FAILED,
    payload: {
        error,
    },
